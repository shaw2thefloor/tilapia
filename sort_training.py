...
input_dir = "/Users/fshaw/Documents/dogs/Images/"
output_dir = "/Users/fshaw/Documents/dogs/split/"
...
for idx, dir in enumerate(os.walk(input_dir)):
    if idx > 0:
        # get dir name
        temp_dir_name = dir[0]
        out_test_name = temp_dir_name.replace('Images', 'split/test')
        out_train_name = temp_dir_name.replace('Images', 'split/train')
