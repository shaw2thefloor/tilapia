...
for dir in os.listdir(proj_dir):
    ...
    train_generator = train_datagen.flow_from_directory(proj_dir / dir / "train",
                                                        target_size=(299, 299),
                                                        color_mode='rgb',
                                                        batch_size=10,
                                                        class_mode='categorical',
                                                        shuffle=True)
    val_generator = train_datagen.flow_from_directory(proj_dir / dir / "test",
                                                      target_size=(299, 299),
                                                      color_mode='rgb',
                                                      batch_size=10,
                                                      class_mode='categorical',
...
print(classification_report(val_generator.classes, y_pred_mx, target_names=target_names))
'''